...
# TJN database
  ...
  $connection{'tjn_oldOracle'}{'probeweb'}{'readwrite'}=[('dbi:Oracle:m17pmis1','probeweb','probeweb')];
  $connection{'jn'}{'probeweb'}{'readwrite'}=[('dbi:Oracle:m17pmis1','probeweb','probeweb')];
  $connection{'tjn'}{'probeweb'}{'readwrite'}=[('dbi:Oracle:m17pmis1','probeweb','probeweb')];
  $connection{'tjn'}{'diamond'}{'read'}=[('dbi:Teradata:fsltdprd.am.freescale.net;RSPBUFSZ=1048576;REQBUFSZ=1048576','TJN_DATA','TJN_DATA')];
